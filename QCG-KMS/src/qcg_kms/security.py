...
_CSP = (
    "default-src 'self'; "
    # Map tiles for the monitoring dashboard are images served by the
    # OpenStreetMap tile network. We allow those image sources specifically
    # (images only, from known tile hosts); everything else stays 'self'.
